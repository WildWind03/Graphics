...
import ru.nsu.fit.g14201.chirikhin.controller.*;
...
public class MyJFrame extends JFrame {
    ...
    private static final String NEW_ICON_PATH = "/create_icon.png";
    private static final String OPEN_ICON_PATH = "/open_icon.png";
    private static final String SAVE_ICON_PATH = "/save_icon.png";
    ...
    public MyJFrame(int width, int height, int lineLength, int lineWidth) {
        ...
        ImageIcon newIcon = new ImageIcon(getClass().getResource(NEW_ICON_PATH));
        newDocumentButton = new JButton(newIcon);
        newDocumentButton.setToolTipText(CREATE);
        jToolBar.add(newDocumentButton);

        ImageIcon openIcon = new ImageIcon(getClass().getResource(OPEN_ICON_PATH));
        openButton = new JButton(openIcon);
        openButton.setToolTipText(OPEN);
        jToolBar.add(openButton);

        ImageIcon saveIcon = new ImageIcon(getClass().getResource(SAVE_ICON_PATH));
    ...
    public void setOnSaveGameListener(StringRunnable runnable) {
        saveFunction = () -> {
            ...
            jFileChooser.setCurrentDirectory(new File(MAPS_FOLDER));
